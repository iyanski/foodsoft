...
describe Order do
  ...
  it 'automaticly finishes ended' do
    ...
    create :order, created_by: User.first, starts: Date.yesterday, ends: 1.hour.from_now, auto_finish: true
    order = create :order, created_by: User.first, starts: Date.yesterday, ends: 1.hour.ago, auto_finish: true
